	...
	<div class="l-breadcrumbs">
		<div class="l-breadcrumbs__inner">
			<ol class="l-breadcrumbs__items">
				...
				<li class="l-breadcrumbs__item"><a href="<?= get_permalink( get_page_by_path('tools')->ID );?>"><?= get_the_title( get_page_by_path('tools')->ID );?></a></li>
		...
		<div class="l-structure__inner">
			<div class="l-main js-pswp">
				...
				<dl class="p-entry-position">
					...
					<dd class="p-entry-position__detail">
					<?php $targets = get_field('work_target'); ?>
					<?php foreach($targets as $target):  echo $target; endforeach;?>
					</dd>
				</dl>
			...
			<div class="l-pager">
				<div class="p-entry-pager">
					...
					<p class="p-entry-pager__item p-entry-pager__item--archive">
						<a href="<?= get_permalink( get_page_by_path('tools')->ID );?>"><span></span></a>
					</p>
				</div>
			</div>
		</div>
